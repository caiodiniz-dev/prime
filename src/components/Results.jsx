        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-10 md:gap-16 items-center">
          ...
          <div className="lg:col-span-1">
            ...
            <motion.h2
              ...
              className="font-display font-black text-prime-black leading-tight mb-5 md:mb-6"
            ...
            <motion.blockquote
              ...
              className="font-accent italic text-prime-black/65 text-[15px] md:text-[17px] leading-relaxed border-l-2 border-prime-black/20 pl-4 mb-4"
            >
              ...
              categorias. A qualidade do conteúdo é incomparável no mercado."
            </motion.blockquote>
            ...
            <motion.p
              ...
              className="font-body font-bold text-[10px] md:text-[11px] tracking-[1.5px] uppercase text-prime-black/55"
            >
              — Coordenador Técnico
              <br />
          ...
          {/* Right — Numbers grid */}
          <div className="lg:col-span-2 grid grid-cols-2 gap-px bg-prime-black/10">
